!function(n) {
    ...
    woodmartThemeModule.mobileNavigation = function() {
        ...
        e.on("click", ".wd-header-mobile-nav > a", function(e) {
            e.preventDefault(),
            o.hasClass("wd-opened") ? woodmartThemeModule.closeMobileNavigation() : (o.addClass("wd-opened"),
        ...
        e.on("click", ".mobile-nav .login-side-opener, .mobile-nav .close-side-widget", function() {
            woodmartThemeModule.closeMobileNavigation()
        })
    }
    ,
