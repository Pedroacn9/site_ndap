    ...
    woodmartThemeModule.ajaxSearch = function() {
        void 0 !== w.fn.devbridgeAutocomplete && w("form.woodmart-ajax-search").each(function() {
            ...
            o.find('[type="text"]').on("focus keyup", function() {
                ...
                a.hasClass("wd-search-inited") || (a.devbridgeAutocomplete({
                    serviceUrl: c,
                    appendTo: i,
                    minChars: d,
                    ...
                    beforeRender: function(e) {
                        ...
                        2 < e[0].childElementCount && w(e).append('<div class="view-all-results"><span>' + woodmart_settings.all_results + "</span></div>"),
                    ...
                    formatResult: function(e, t) {
                        ...
                        s && e.thumbnail && (a += ' <div class="suggestion-thumb">' + e.thumbnail + "</div>"),
                ...
                r.length && (e = o.find('[type="text"]').devbridgeAutocomplete(),
                t = woodmart_settings.ajaxurl + "?action=woodmart_ajax_search",
                0 < n && (t += "&number=" + n),
                t += "&post_type=" + l,
